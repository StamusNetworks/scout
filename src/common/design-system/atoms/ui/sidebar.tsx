...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@/common/design-system/atoms/ui/sheet';
...
import { useIsMobile } from '@/common/lib/use-mobile';
  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'bg-sidebar text-sidebar-foreground [&_svg]:text-sidebar-icon flex h-full w-(--sidebar-width) flex-col',
            className,
          )}
          ref={ref}
          {...props}
      ...
      return (
        ...
        >
          <SheetContent
            ...
            data-mobile="true"
            className="bg-sidebar text-sidebar-foreground [&_svg]:text-sidebar-icon w-(--sidebar-width) p-0 [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            '[&_svg]:text-sidebar-icon relative w-(--sidebar-width) bg-transparent',
        ...
        <div
          className={cn(
            '[&_svg]:text-sidebar-icon fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) md:flex',
            side === 'left'
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={cn('relative flex w-full min-w-0 flex-col px-1', className)}
      {...props}
    />
  );
});
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-bold transition-[margin,opacity] outline-none focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
