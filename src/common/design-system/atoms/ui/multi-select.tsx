 ...
 */
const multiSelectVariants = cva('py-0.5 shadow-none', {
  variants: {
    variant: {
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            variant="outline"
            className={cn(
              'flex h-auto min-h-10 w-full cursor-default items-center justify-between rounded-md border bg-inherit p-1 hover:bg-inherit [&_svg]:pointer-events-auto',
              className,
            )}
          >
                ...
                <div className="flex flex-wrap items-center gap-1">
                  {selectedValues.slice(0, maxCount).map((value) => {
                    ...
                    return (
                      <Badge
                        key={value}
                        className={cn(multiSelectVariants({ variant }), 'pr-1')}
                      >
                        {IconComponent && (
