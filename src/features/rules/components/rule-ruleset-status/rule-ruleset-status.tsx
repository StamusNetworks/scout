...
interface RuleRulesetStatusProps {
  ruleId: number;
}

export const RuleRulesetStatus = ({ ruleId }: RuleRulesetStatusProps) => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent className="w-fit max-w-[800px]">
        <RuleRulesetStatusContent ruleId={ruleId} />
      </PopoverContent>
    </Popover>
  );
};

export const RuleRulesetStatusContent = ({
  ruleId,
}: RuleRulesetStatusProps) => {
