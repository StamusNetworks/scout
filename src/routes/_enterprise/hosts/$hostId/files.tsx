...
import { HostFilesTable } from '@/features/host-insights';
...
export const Route = createFileRoute('/_enterprise/hosts/$hostId/files')({
  validateSearch: searchSchema,
  component: () => (
    <PageBoundary key="host-files">
      <HostFilesTab />
    </PageBoundary>
  ),
});

function HostFilesTab() {
